...
class BillingModel {
  ...
  BillingModel({this.id, this.month, this.year, this.card, this.paid, this.billingDueDay, this.billingStartDay});
      ...
      card: billing["card_id"] != null
          ? CardModel(
              ...
              bank: billing["bank_id"] != null
                  ? BankModel(id: billing["bank_id"], name: billing["bank_name"], imageUrl: billing["bank_image"])
                  : null,
              brand: billing["brand_id"] != null
                  ? BrandModel(id: billing["brand_id"], name: billing["brand_name"], imageUrl: billing["brand_image"])
                  : null,
